    ...
    [ CamlImages.Images.Index8 x ->
      {
        ...
        bm_height   = height;
        bm_depth    = 8;
        bm_scanline = fun y -> Bytes.to_string (CamlImages.Index8.get_scanline x y)
      }
    | CamlImages.Images.Index16 x ->
      {
        ...
        bm_height   = height;
        bm_depth    = 8;
        bm_scanline = fun y -> Bytes.to_string (CamlImages.Rgb24.get_scanline (CamlImages.Index16.to_rgb24 x) y)
      }
    | CamlImages.Images.Rgb24 x ->
      {
        ...
        bm_height   = height;
        bm_depth    = 8;
        bm_scanline = fun y -> Bytes.to_string (CamlImages.Rgb24.get_scanline x y)
      }
    | CamlImages.Images.Rgba32 x ->
      {
        ...
        bm_height   = height;
        bm_depth    = 8;
        bm_scanline = fun y -> Bytes.to_string (CamlImages.Rgba32.get_scanline x y)
      }
    | CamlImages.Images.Cmyk32 x ->
      {
        ...
        bm_height   = height;
        bm_depth    = 8;
        bm_scanline = fun y -> Bytes.to_string (CamlImages.Cmyk32.get_scanline x y)
      }
    ]
  with
